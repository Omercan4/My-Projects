...
| [Conversational Schedule Explainer (ChatGPT API)](Bachelor%20Projects/Graduation%20Project%20-%20Conversational%20Schedule%20Explainer%20using%20ChatGPT%20API) | Optimization + LLM explanations (graduation project) | Gurobi, ChatGPT API |
| [Predicting Bank Term Deposits & Seoul Bike Rentals](Bachelor%20Projects/Predicting%20Bank%20Term%20Deposits%20and%20Seoul%20Bike%20Rentals%20using%20Machine%20Learning%20and%20Data%20Analysis) | Classification & regression, model comparison | R |
...
| [Forecasting Gasoline Prices](Bachelor%20Projects/Forecasting%20Gasoline%20Prices%20using%20Time%20Series%20and%20Regression) | Time-series forecasting & regression | Time-series methods |
| [Customer Segmentation for East-West Airlines](Bachelor%20Projects/Customer%20Segmentation%20Analysis%20for%20East-West%20Airlines) | Clustering & marketing analytics | R |
...
simulation-based inference, time series & forecasting ·
**Generative AI:** LLM APIs (ChatGPT), prompt engineering ·
**Operations Research:** optimization (Gurobi), discrete-event simulation (ARENA/Python), scheduling ·
**Tools:** Git, LaTeX, Excel
